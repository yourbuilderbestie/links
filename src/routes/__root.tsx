...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Jenna Ahrens" },
      { property: "og:title", content: "Your Builder Bestie | Jenna Ahrens" },
      { property: "og:description", content: "Your Builder Bestie at Meritage Homes – Connect with Jenna Ahrens" },
